...
class Test:
            ...
            for ruleNumber in range(0, 81):
                ...
                for testNumber in range(0, 250):
                    ...
                    if len(ruleCheckErrorList) == 0:
                        flash("EXPERIMENT-TestRoomRuleVerification [SUCCESS]:" + "#rules=" + str(
                            ruleNumber) + " - opTimeMilliseconds:" + str(opTimeMilliseconds))
                    else:
                        flash("EXPERIMENT-TestRoomRuleVerification [FAILED]:" + "#rules=" + str(
                            ruleNumber) + " - opTimeMilliseconds:" + str(opTimeMilliseconds))
    ...
    def test5(self):
        ...
        buildingSimulator = BuildingSimulator(buildingName="CSE", startDate="2014-09-15", numberOfDays=7,
                                              roomFilter=None)
        buildingSimulator.start()
    ...
    def test4(self):
        ...
        roomSimulator = RoomSimulator(occupancyTimeRangeFrom="4:00AM", occupancyTimeRangeTo="6:00PM",
                                      buildingName="CSE", roomName="3208", roomTemperature="78F",
                                      externalTemperature="75F", weather="Sunny")
        roomSimulator.start()
    ...
    def test3(self):
        ...
        translatedTriggers = triggerManager.translateTrigger(
            "someone is in the room, it is cloudy, it is rainy, time is between 10:00 and 11:00")
    ...
    def test0(self):
        ...
        user = User(username="alenacci", email="alenacci@gmail.com", password="1234", personName="Alessandro Nacci",
                    level=10)
        user.store()
