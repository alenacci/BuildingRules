...
def writeSimulationLog(simulationParameters, actionTargetName, actionTargetStatus):
    ...
    if "stateNumber" not in simulationParameters:
        ...
        line = simulationParameters["date"] + ";" + simulationParameters["time"] + ";" + actionTargetName + ";" + str(actionTargetStatus) + ";" + str(simulationParameters["ruleId"]) + ";" + str(simulationParameters["ruleText"]) + ";" + str(simulationParameters["stateNumber"])
